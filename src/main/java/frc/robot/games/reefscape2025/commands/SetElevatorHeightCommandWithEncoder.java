...
/**
 * Command to set elevator height using encoder-based position feedback.
 * This is the encoder version of SetElevatorHeightCommand.
 */
public class SetElevatorHeightCommandWithEncoder extends Command {
    ...
    public SetElevatorHeightCommandWithEncoder(ElevatorSubsystemWithEncoder elevator, double wantedHeight, boolean stopper) {
