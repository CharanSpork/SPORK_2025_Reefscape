package frc.robot.games.reefscape2025.subsystems.drive;
...
public class DriveConstants_SporkBob {
    ...
    public static final Rotation2d frontRightZeroRotation = new Rotation2d(tau * 0.647); // Encoder ID 3
